...
// In general, could be SVGProps if using @ui-kitten-react-native/eva-icons or ImageProps if using Image.
 ...
 * In case of using `@ui-kitten-react-native/eva-icons` package, Icon accepts any props for react-native-svg component.
 *
