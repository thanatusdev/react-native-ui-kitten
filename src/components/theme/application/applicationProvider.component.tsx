 ...
 * Can be improved with build-time processing with `@ui-kitten-react-native/metro-config` package.
 *
 ...
 * Usually, can be provided by `@ui-kitten-react-native/metro-config` package.
 *
